		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ParkingLot Application",
									"targetURL": "#comappparkapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappparkapplication-display": {
								"semanticObject": "comappparkapplication",
								"action": "display",
								"description": "Parking Lot Applications",
								"title": "ParkingLot Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.parkapplication",
									"url": sap.ui.require.toUrl("com/app/parkapplication")
								}
							}
						}
					}
